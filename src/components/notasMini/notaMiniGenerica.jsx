  ...
  <>
    <div style={{ width, marginLeft: "50px", padding: "0px", marginTop, display: "flex", flexDirection: "column" }} className="contenedorMiniNotaGenerica">
      ...
      <div className="col-auto p-0 mt-3" style={{ height: tieneContenido ? "auto" : "auto" }}>
        ...
        <p style={{ fontSize: fontSizeTitulo, fontWeight: "bold", marginTop: "10px", color: "#101828", marginBottom: "5px" }}>{nota.titulo}</p>
        {tieneContenido &&
          <p style={{ fontSize: fontSizeContenido, marginTop: "0px", color: "#101828", opacity: "75%" }}>{nota.copete}</p>
        }
      </div>
